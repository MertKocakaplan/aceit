                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <select
                        ...
                        required
                        className="w-full pl-12 pr-4 py-3.5 bg-white dark:bg-neutral-800 border-2 border-neutral-200 dark:border-neutral-700 rounded-xl focus:border-primary-500 dark:focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all outline-none font-sans text-neutral-900 dark:text-white appearance-none cursor-pointer"
                      >
